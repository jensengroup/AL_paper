seeds_3_known = [
    ...
    [
        "COc1ccc2cc(C(=O)N3CCC(O)(Cc4ccncc4)CC3)c(C)nc2c1",
    ...
    [
        ...
        "O=C(CCCc1c[nH]c2ccccc12)N[C@@H]1C[C@H](Cn2ccnc2)C[C@@H]1O",
        "CS(=O)(=O)[C@@H]1CCN(C(=O)c2cccnc2N2CCCC2)C1",
    ],
    [
        "O=C(c1n[nH]c2ccc([N+](=O)[O-])cc12)N1CC[C@H](C(F)(F)F)[C@@H](CO)C1",
    ...
    [
        ...
        "O=C(O[C@H]1CCN(c2ccccc2Cl)C1=O)c1n[nH]c(=O)c2ccccc12",
