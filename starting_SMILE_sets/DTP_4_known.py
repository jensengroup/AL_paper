seeds_4_known = [
    [
        "O=C(CCl)NCc1cnccn1",
        "COc1c(OC)c([O-])c2c(=O)c(C)c(/C=C/c3cc(O)cc(O)c3)oc2c1OC",
        "Cc1ccc(S(=O)(=O)N2Cc3ccc([N+](=O)[O-])cc3C2)cc1",
        "CCSC[C@H]1C[C@](O)(c2c(C)nn(Cc3ccccc3)c2C)C(=O)O1",
        "Nc1nc(N)c2nc(-c3ccc(O)cc3)c(-c3ccc(O)cc3)nc2n1",
        ...
        "OC[C@H]1O[C@@H](Oc2cc(/C=C/c3ccc(O)cc3)ccc2O)[C@H](O)[C@@H](O)[C@@H]1O",
    ],
    [
        "CC(=O)Nc1ccc(S(=O)(=O)c2ccc(NC=O)cc2)cc1",
        ...
        "CCCCc1cc(O)ccc1O",
        "CSC(=[NH2+])c1cccc(CCCCc2ccc(NC(C)=O)cc2)c1",
        "COc1cc([C@@H]2C[C@@](C)(O)Oc3cc4c(cc32)OCO4)cc(OC)c1O",
        "C/C=C/[C@H](C(=O)NC(N)=O)C(C)C",
        "C=CCNC(=S)NCc1cccc2ccccc12",
    ],
    [
        "CCN(CC)/[NH+]=C/C[C@H](C)Nc1ccnc2cc(Cl)ccc12",
        "CC1(C)CC(=O)C(c2c(-c3ccccc3)[nH]c3[nH]c(=S)[nH]c(=O)c23)=C([O-])C1",
        "CC(=O)Nc1nc(N)nc2c1C[C@H](N(Cc1ccc(Cl)cc1)C(C)=O)CC2",
        "O=C([O-])c1cccc(O)c1O",
    ...
    [
        ...
        "COc1ccc2c(c1)C(=O)c1c-2n(CCCCl)c(=O)c2cc(N)ccc12",
        "O=C([O-])[C@H](c1ccccc1)c1cccc([C@@H](C(=O)[O-])c2ccccc2)n1",
        "Oc1ccc([C@H]2COc3c(ccc(O)c3O)C2)cc1",
        "OCCCCC[NH2+]C1CCCCC1",
        "C1=Nc2c(ncnc2SCc2ccccc2)NN1",
        "CC1(C)O[C@@H]1C(=O)[O-]",
        "O=C1/C(=C/c2ccc(O)c(O)c2)Cc2ccccc21",
        "c1nc2c3c4c(sc3ncn2n1)CCCC4",
        "O=C(N[C@H]1c2ccccc2C[C@H]1O)[C@H](Cc1ccccc1)NCC(F)(F)F",
    ],
    [
        "COc1ccc(Cl)c(S(N)(=O)=O)c1",
        "Nc1nc(N)c(CCCNc2ccccc2)c(Cc2ccccc2)n1",
    ...
    [
        ...
        "COc1c2c(c(OC)c3c1C(=O)c1ccccc1[C@@H]3O)CC=CC2",
        "CCn1c(Cl)c(/C=[NH+]\\Nc2ccc([N+](=O)[O-])cc2)c2ccccc21",
        "N#CS/C=C\\C(N)=O",
        "N#C/C(=C\\c1ccc(O)c(O)c1)c1c(C#N)c(N)nn1-c1ccccc1",
        "COc1cc2c(c3oc4c(O)cccc4c(=O)c13)C[C@H]([C@@](C)(O)CCl)O2",
    ],
    [
        "CCc1ccccc1-n1c(=O)c(C#N)c(-c2ccc(O)cc2)c2c(N)n[nH]c21",
        "COc1ccc([C@H]2COc3c(ccc(O)c3O)C2)cc1OC",
        "NC(=O)c1cccc(NC=O)c1",
        "CC(=O)c1ccccc1Br",
        ...
        "CCC[C@H]1OCCN1CC",
        "O=C1C=C(c2c(O)ccc3ccccc23)c2cc(O)ccc2C1=O",
    ],
    [
    ...
    [
        ...
        "CC(=O)Oc1cccnc1",
        "COc1ccc(-c2ccc([C@@H]3CC(c4ccc(Cl)cc4)=[NH+]N3)o2)c([N+](=O)[O-])c1",
        "CCCC(=O)Nc1ccc(C)cc1",
    ...
    [
        ...
        "O=C(CCl)Nc1cccc2c1C(=O)c1c(c(O)c3ccccc3c1O)C2=O",
        "CC(C)(C)[Si](C)(C)OC[C@]12CC[C@H]3C[NH2+][C@H]([C@H]31)[C@H](c1ccccc1)N2",
        "O[C@H](COc1ccccc1)CC(O)(C(F)(F)F)C(F)(F)F",
        "CCn1cc(C(=O)[O-])c(=O)c2ccc(C)[n+](C)c21",
        "CC(=O)C(=Cc1cccc([N+](=O)[O-])c1)C(C)=O",
        "Oc1ccc(O)c(CNc2ccc([C@@H](O)C(F)(F)F)cc2)c1",
        "COc1ccc([C@](O)(c2ccccc2)[C@H](C)O)cc1",
    ],
    [
        "Nc1nc(N)c(NC/C=C\\c2ccc([N+](=O)[O-])cc2)c(-c2ccccc2)n1",
        "CC(=O)Nc1nc(-c2nnc(S)n2-c2ccc(Cl)cc2)cs1",
        "COc1c(O)cc2c(c1O)C(=O)/C(=C/c1ccc(O)cc1)CO2",
        "CC(=O)Nc1ccc(S(=O)(=O)CCBr)cc1",
        "O=c1c2ccccc2ncn1-c1ccc(O)c(C[NH+](CCCl)CCCl)c1",
        "O=C([O-])c1ccc(Oc2ccccc2)cc1",
        "COc1ccc([C@H](O)CC(O)(C(F)(F)F)C(F)(F)F)cc1",
    ...
    [
        ...
        "NC(=O)[C@H](c1ccccc1)C(O)(c1ccccc1)c1ccccc1",
        "CCOC(=O)/C(C#N)=C(\\C)c1ccccc1",
        "O=c1nc(SCc2ccccc2)[nH]c(Cc2ccccc2)c1CCO",
    ...
    [
        ...
        "COc1cc(C(=O)C[C@]2(O)C(=O)Nc3c(Cl)cc(Cl)cc32)ccc1O",
        "O=C([O-])c1cccc(N2C(=O)CSC2=S)c1",
        "Cc1ncc(CO)c(CSSCc2c(CO)cnc(C)c2O)c1O",
        "CC(C)[C@@H](NC(=O)c1cnc2ccccc2n1)C(=O)N[C@@H](C)C(=O)[O-]",
        "O=c1[nH]c(Nc2cccc(CC(F)(F)F)c2)nc2[nH]cnc12",
        "O=c1c2ccccc2sc2c1c(N(CCO)CCO)cc1ccccc12",
        "COc1c(O)cc2c(c1OC)-c1ccc(SC)c(=O)cc1C[C@H](NC=O)C2",
    ...
    [
        ...
        "O=C([O-])/C=C\\C(=O)Nc1ccc2c(c1)[C@H](NC(=O)C(F)(F)F)c1ccccc1-2",
        "COc1ccccc1C(=O)Sc1ccccc1C(=O)N[C@H](C(N)=O)C(C)C",
        "Cn1c(=O)nc2n(-c3ccc(Cl)cc3)c3ccc(Cl)cc3nc-2c1=O",
        "O=C1CC2(CCCC2)CC(=O)N1c1ccc(O)c(CN2CCOCC2)c1",
        "O=C(CCCc1ccncc1)c1ccccc1",
        "O=C(NC(=S)NC(=O)c1cc(O)c(O)c(O)c1)c1cc(O)c(O)c(O)c1",
    ...
    [
        ...
        "NC(=O)c1c(N)nn2c(-c3ccccc3)cc(-c3ccccc3)cc12",
        "CC(=O)Nc1ccc2c(c1)[nH]c(=O)c1ccccc12",
    ...
    [
        ...
        "Cc1cc(OCCc2ccccc2)ccc1Nc1cc(=O)[nH]c(=O)[nH]1",
        "CC[C@@]1(O)C(=O)OCc2c1cc1n(c2=O)Cc2cc3cccc(N)c3nc2-1",
        "C=Cc1c(C)cc(C)cc1C",
        "O=c1ccc(=O)c2c1c1[nH]c3ccccc3c1c1c(=O)c3ccccc3c(=O)c21",
    ...
    [
        ...
        "N#Cc1c(N2CC[C@H](O)C2)c2ccccc2n2c1nc1ccccc12",
        "O=C(c1ccc([N+](=O)[O-])cc1)c1ccc(O)cc1O",
        "Cc1cccc(Cl)c1OCC(N)=O",
        "C/C=C/C=N/c1c(C#N)c2n(c1C(=O)Nc1ccc(S(N)(=O)=O)cc1)CCC2",
        "CCO[C@H]([C@@H](OCC)[n+]1ccccc1)[n+]1ccccc1",
    ],
    [
        "Cn1cc(C2=C(c3cccc(Cl)c3)C(=O)NC2=O)c2ccccc21",
        "O=C1c2ccccc2C(=O)c2c(O)c(NCCO)cc(O)c21",
        ...
        "COc1ccc2c(c1)CC[C@@H]1[C@@H]2CC[C@]2(C)[C@@H](O)[C@@H](O)C[C@@H]12",
    ],
    [
        "CCOC(=O)[C@H]1C[C@H](O)C[NH2+]1",
        "COc1ccc2cc(C(N)=O)/c(=N/c3cccc(C#N)c3)oc2c1",
        "CN1C(=O)N(C)C(=O)C(Nc2ccc([N+](=O)[O-])cc2)(SCCO)C1=O",
        "O=NN(CCCl)C(=O)Nc1ccc(CC(=O)[O-])cc1",
        "COc1ccc2c(c1)C/C(=C\\c1ccc(O)c(OC)c1)C2=O",
        "C[N+](C)(C)CC(=O)N/[NH+]=C/c1ccc([N+](=O)[O-])o1",
        "COc1cc2ccccc2[n+](C)c1-c1ccccc1F",
        "O=C(Nc1c(C(=O)NC2CCCCC2)[nH]c(=O)[nH]c1=O)c1ccc(Cl)cc1",
    ...
    [
        ...
        "CC[C@@]1(O)C(=O)OCc2c1cc1n(c2=O)Cc2cc3cc(N)ccc3nc2-1",
        "O=C1N=C(N2CCN(c3ccccc3)CC2)N[C@@H]2CCCC[C@H]12",
        "C=CC[C@@]1(O)c2cccc(O)c2C(=O)c2cccc(O)c21",
    ...
    [
        ...
        "Cc1ccc(O)c(C2=CC3=[NH+]NC(=O)[C@@H]3[C@@H](c3cccc(Cl)c3)C2)c1",
        "COc1cc2c(c(O)c1C)C(=O)C[C@H](c1ccccc1)O2",
        "Cc1cc(O)c(C(C)C)cc1C[NH+]1CCCCC1",
        "COc1cc([C@H](O)C(=O)c2nc3ccc([N+](=O)[O-])cc3nc2O)ccc1O",
